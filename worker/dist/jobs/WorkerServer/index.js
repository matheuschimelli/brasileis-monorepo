...
var queue = (0, jobUtils_1.createJob)("WorkerServer");
        ...
        return __generator(this, function (_a) {
            ...
            try {
                switch (job.data.queue) {
                    case "DefaultCrawler":
                        defaultCrawler_1.default.queue.add(__assign({}, job.data.jobData));
                        break;
                    case "CrawlerTest":
                        testCrawler1_1.default.queue.add(__assign({}, job.data.jobData));
                        break;
                    default:
                        break;
                }
