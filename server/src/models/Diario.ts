...
import PaginaDiarioOficial from './DiarioOficial/PaginaDiarioOficial'
...
class DiarioOficial {
  ...
  */
    ...
    @OneToMany(() => PaginaDiarioOficial, paginaDiarioOficial => paginaDiarioOficial.parent, {
      cascade: true
    })
    paginas!: PaginaDiarioOficial[]
