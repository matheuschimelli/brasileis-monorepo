...
import { UserUpdateOneRequiredWithoutMembershipsInput } from "../inputs/UserUpdateOneRequiredWithoutMembershipsInput";

@TypeGraphQL.InputType("MembershipUpdateInput", {
  isAbstract: true
})
export class MembershipUpdateInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateOneRequiredWithoutMembershipsInput, {
    nullable: true
  })
  user?: UserUpdateOneRequiredWithoutMembershipsInput | undefined;
}
