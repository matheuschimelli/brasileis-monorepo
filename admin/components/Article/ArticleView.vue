<template>
  <v-row>
    <v-col cols="12" sm="12" md="9" lg="9">
      <v-card>
        <v-card-title>
          <ArticleTitleInput v-model="data.title" />
        </v-card-title>
        <v-card-text>
          <v-textarea
            v-model="data.summary"
            label="Resumo, sumário"
            placeholder="Breve resumo sumário"
            outlined
          />
        </v-card-text>
        <v-card-text class="editArticle">
          <TextEditor v-model="data.content" />
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="12" md="3" lg="3">
      <v-card>
        <v-card-title>Colocar em destaque</v-card-title>
        <v-card-subtitle
          >O destaque remove do destaque o artigo anterior</v-card-subtitle
        >
        <v-card-text>
          <v-checkbox v-model="data.featured" label="Destacar na home" />
        </v-card-text>
      </v-card>
