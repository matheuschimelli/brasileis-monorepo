...
export const JurisprudenciaRender = ({ jurisprudencia, renderContent }: { jurisprudencia: any, renderContent?: boolean }) => {
            ...
            >
                <Box display="flex" flexDir={["column", "column", "row"]} alignItems="baseline">
                    {/* <Menu>
                        ...
                        <MenuList>
                            <Link href={`/finder/yyyy/wwwww`} passHref>
                                <MenuItem as="a">Abrir Artigo</MenuItem>
                            </Link>
                            <MenuItem onClick={() => handleCopyClipboard(jurisprudencia)}>Copiar</MenuItem>
                        </MenuList>
                    </Menu> */}
                    <Box>
                        <Text
                        ...
                        >
                            {/* <Link href={`/finder/aaa/eee`} passHref>
