...
// function generateESQuery(searchTerm: string, categories: string[], subCategories: string[]) {
...
//         const searchQuery = generateESQuery(searchParams.term, categories, subCategories)
...
//   async removeDoc(removeDocParams: RemoveDocParams) {
