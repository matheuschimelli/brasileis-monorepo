...
exports.UpsertLawBlockResolver = void 0;
...
let UpsertLawBlockResolver = class UpsertLawBlockResolver {
...
], UpsertLawBlockResolver.prototype, "upsertLawBlock", null);
UpsertLawBlockResolver = (0, tslib_1.__decorate)([
    TypeGraphQL.Resolver(_of => LawBlock_1.LawBlock)
], UpsertLawBlockResolver);
exports.UpsertLawBlockResolver = UpsertLawBlockResolver;
