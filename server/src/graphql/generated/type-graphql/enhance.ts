...
const crudResolversMap = {
  ...
  Membership: crudResolvers.MembershipCrudResolver
};
const actionResolversMap = {
  ...
  Membership: {
    membership: actionResolvers.FindUniqueMembershipResolver,
    findFirstMembership: actionResolvers.FindFirstMembershipResolver,
    memberships: actionResolvers.FindManyMembershipResolver,
    createMembership: actionResolvers.CreateMembershipResolver,
    createManyMembership: actionResolvers.CreateManyMembershipResolver,
    deleteMembership: actionResolvers.DeleteMembershipResolver,
    updateMembership: actionResolvers.UpdateMembershipResolver,
    deleteManyMembership: actionResolvers.DeleteManyMembershipResolver,
    updateManyMembership: actionResolvers.UpdateManyMembershipResolver,
    upsertMembership: actionResolvers.UpsertMembershipResolver,
    aggregateMembership: actionResolvers.AggregateMembershipResolver,
    groupByMembership: actionResolvers.GroupByMembershipResolver
  }
};
const crudResolversInfo = {
  ...
  Membership: ["membership", "findFirstMembership", "memberships", "createMembership", "createManyMembership", "deleteMembership", "updateMembership", "deleteManyMembership", "updateManyMembership", "upsertMembership", "aggregateMembership", "groupByMembership"]
};
const argsInfo = {
  ...
  FindUniqueMembershipArgs: ["where"],
  FindFirstMembershipArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyMembershipArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateMembershipArgs: ["data"],
  CreateManyMembershipArgs: ["data", "skipDuplicates"],
  DeleteMembershipArgs: ["where"],
  UpdateMembershipArgs: ["data", "where"],
  DeleteManyMembershipArgs: ["where"],
  UpdateManyMembershipArgs: ["data", "where"],
  UpsertMembershipArgs: ["where", "create", "update"],
  AggregateMembershipArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByMembershipArgs: ["where", "orderBy", "by", "having", "take", "skip"]
};
...
const relationResolversMap = {
  ...
  Membership: relationResolvers.MembershipRelationsResolver
};
const relationResolversInfo = {
  ...
  Post: ["User"],
  Profile: ["User"],
  User: ["profile", "posts", "memberships"],
  Membership: ["user"]
};
...
const modelsInfo = {
  ...
  Membership: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"]
};
...
const outputsInfo = {
  ...
  AggregateMembership: ["_count", "_min", "_max"],
  MembershipGroupBy: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId", "_count", "_min", "_max"],
  ...
  MembershipCountAggregate: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId", "_all"],
  MembershipMinAggregate: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  MembershipMaxAggregate: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"]
};
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "name", "email", "username", "tokens", "admin", "googleId", "createdAt", "updatedAt", "role", "profile", "posts", "memberships"],
  UserOrderByWithRelationInput: ["id", "name", "email", "username", "tokens", "admin", "googleId", "createdAt", "updatedAt", "role", "profile", "posts", "memberships"],
  ...
  MembershipWhereInput: ["AND", "OR", "NOT", "id", "user", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  MembershipOrderByWithRelationInput: ["id", "user", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  MembershipWhereUniqueInput: ["id"],
  MembershipOrderByWithAggregationInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId", "_count", "_max", "_min"],
  MembershipScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  ...
  UserCreateInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "profile", "posts", "memberships"],
  UserUpdateInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "profile", "posts", "memberships"],
  ...
  MembershipCreateInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "user"],
  MembershipUpdateInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "user"],
  MembershipCreateManyInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  MembershipUpdateManyMutationInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt"],
  ...
  MembershipListRelationFilter: ["every", "some", "none"],
  PostOrderByRelationAggregateInput: ["_count"],
  MembershipOrderByRelationAggregateInput: ["_count"],
  ...
  MembershipCountOrderByAggregateInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  MembershipMaxOrderByAggregateInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  MembershipMinOrderByAggregateInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  ...
  MembershipCreateNestedManyWithoutUserInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  MembershipUpdateManyWithoutUserInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  UserCreateManytokensInput: ["set"],
  UserCreateNestedOneWithoutMembershipsInput: ["create", "connectOrCreate", "connect"],
  UserUpdateOneRequiredWithoutMembershipsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  UserCreateWithoutPostsInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "profile", "memberships"],
  UserCreateOrConnectWithoutPostsInput: ["where", "create"],
  UserUpsertWithoutPostsInput: ["update", "create"],
  UserUpdateWithoutPostsInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "profile", "memberships"],
  UserCreateWithoutProfileInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "posts", "memberships"],
  UserCreateOrConnectWithoutProfileInput: ["where", "create"],
  UserUpsertWithoutProfileInput: ["update", "create"],
  UserUpdateWithoutProfileInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "posts", "memberships"],
  ...
  MembershipCreateWithoutUserInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt"],
  MembershipCreateOrConnectWithoutUserInput: ["where", "create"],
  MembershipCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  ...
  MembershipUpsertWithWhereUniqueWithoutUserInput: ["where", "update", "create"],
  MembershipUpdateWithWhereUniqueWithoutUserInput: ["where", "data"],
  MembershipUpdateManyWithWhereWithoutUserInput: ["where", "data"],
  MembershipScalarWhereInput: ["AND", "OR", "NOT", "id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt", "userId"],
  UserCreateWithoutMembershipsInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "profile", "posts"],
  UserCreateOrConnectWithoutMembershipsInput: ["where", "create"],
  UserUpsertWithoutMembershipsInput: ["update", "create"],
  UserUpdateWithoutMembershipsInput: ["id", "name", "email", "username", "admin", "googleId", "createdAt", "updatedAt", "role", "tokens", "profile", "posts"],
  ...
  MembershipCreateManyUserInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt"],
  PostUpdateWithoutUserInput: ["title", "createdAt", "content", "published"],
  MembershipUpdateWithoutUserInput: ["id", "isActive", "startDate", "endDate", "stripeTransactionId", "customerId", "invoiceUrl", "subscriptionId", "receiptUrl", "pdfInvoice", "urlInvoice", "createdAt", "updatedAt"]
};
