...
@TypeGraphQL.InputType("BlockPropertyUpdateInput", {
  isAbstract: true
})
export class BlockPropertyUpdateInput {
  ...
  @TypeGraphQL.Field(_type => LawBlockUpdateOneRequiredWithoutPropertiesInput, {
    nullable: true
  })
